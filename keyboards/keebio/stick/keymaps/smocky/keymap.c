...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
       OSX_LAUNCH_SLACK, SLACK_MENTIONS_TOGGLE, SLACK_HOME_WORKSPACE, SLACK_2_WORKSPACE, SLACK_3_WORKSPACE, SLACK_4_WORKSPACE,    SLACK_HISTORY_PREV,    SLACK_HISTORY_NEXT, ZOOM_AUDIO_TOGGLE,   KC_VOLD,   KC_VOLU,  LT(_CONFIG, KC_MUTE)
    ),
    [_FUNCTION] = LAYOUT(
