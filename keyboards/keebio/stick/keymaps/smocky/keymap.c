...
#define OSX_LAUNCH_SPOTIFY LCTL(LALT(LGUI(KC_S)))
#define OSX_LAUNCH_SLACK LCTL(LALT(LGUI(KC_S)))

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {

    [_BASE] = LAYOUT(
       OSX_AUDIO_OUTPUT_TOGGLE, OSX_LAUNCH_SPOTIFY, SLACK_HOME_WORKSPACE, SLACK_HISTORY_PREV, SLACK_HISTORY_NEXT, SLACK_4_WORKSPACE,    SLACK_HISTORY_PREV,    SLACK_HISTORY_NEXT, KC_MPLY,KC_MUTE, KC_VOLD,  LT(_CONFIG, KC_VOLU)
    ),
    [_FUNCTION] = LAYOUT(
        KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12
    ),
    [_CONFIG] = LAYOUT(
         _______,   RGB_TOG,    RGB_MOD,    RGB_RMOD,     RGB_SPD,    RGB_MODE_BREATHE,    RGB_MODE_PLAIN,    _______,    _______,    _______,   RESET,_______
