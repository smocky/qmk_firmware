...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
       OSX_AUDIO_OUTPUT_TOGGLE, OSX_LAUNCH_SPOTIFY, SLACK_HOME_WORKSPACE, SLACK_HISTORY_PREV, SLACK_HISTORY_NEXT, SLACK_4_WORKSPACE,    SLACK_HISTORY_PREV,    SLACK_HISTORY_NEXT, KC_MUTE,   KC_VOLD,   KC_MPLY,  LT(_CONFIG, KC_VOLU)
    ),
    [_FUNCTION] = LAYOUT(
