...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_60_ansi(
        ...
        KC_LCTL,        KC_LGUI, KC_LALT,                             KC_SPC,                             KC_LEFT, LT(_SPECIAL, KC_DOWN),   LT(_CONFIG, KC_UP),   KC_RIGHT
    ),
     [_NAV] = LAYOUT_60_ansi(
        KC_GESC,        KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC,
    ...
    [_CONFIG] = LAYOUT_60_ansi(
        ...
        RGB_MATRIX_DIGITAL_RAIN, _______, _______,                            _______,                            _______, _______, _______, _______
    )
};
